...
const Footer = () => {
    return (
        <div className="flex w-full flex-col items-center justify-center gap-8 bg-gray-800 p-6 text-center text-white flex-grow">
            <p className="border-b-[.1em] border-white font-medium">
